const projects = [
  {
    ...
    contribution: "ผลงานในรายวิชา Computer Science Project I — พัฒนาระบบด้วย Laravel Framework และภาษา PHP เชื่อมต่อฐานข้อมูล Oracle Database เพื่อรวบรวมขั้นตอนการบริหารวัสดุและครุภัณฑ์ไว้ในแพลตฟอร์มเดียว โดยคำนึงถึงการใช้งานของเจ้าหน้าที่จากหลายพื้นที่ และนำเสนอผลงานในงาน IT Empowering Day 2026",
    stack: ["Laravel Framework", "PHP", "Oracle Database", "Inventory Management", "Asset Tracking"],
